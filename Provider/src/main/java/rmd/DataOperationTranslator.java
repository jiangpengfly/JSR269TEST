...
/**
 * create by jiangpengfei 2021年12月03日00:00:03
 * 参考 https://www.jianshu.com/p/68fcbc154c2f
 *
        ...
        roundEnv.getElementsAnnotatedWith(Data.class).stream().map(element -> trees.getTree(element)).forEach(t -> t.accept(new TreeTranslator() {
            ...
            public void visitClassDef(JCTree.JCClassDecl jcClassDecl) {
                ...
                JCTree.JCImport jcImport = treeMaker.Import(treeMaker.Select(
                        ident, names.fromString("Integer")), false);
                jcClassDecl.defs = jcClassDecl.defs.prepend(jcImport);*/
